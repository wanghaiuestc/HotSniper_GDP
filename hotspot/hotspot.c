...
int main(int argc, char **argv)
{
  ...
  /* print transient temperature results : Modified by Anuj to print transient instead of steady state temperature.*/ 
  //BU_3D: Only print transient temperature results to stdout when DEBUG3D flag is not set
#if DEBUG3D < 1
  //fprintf(stdout, "Unit\Instantanenous(Kelvin)\n");
